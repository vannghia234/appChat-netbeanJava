    ...
    public void run() {
        try {
            ...
            while (!isClosed) {
                ...
                System.out.println("mess server " +message);
                ...
                if(messageSplit[0].equals("send-to-person") && messageSplit[4].equals("isTyping")  ){
                    Server.serverThreadBus.sendMessageToPersion(Integer.parseInt(messageSplit[3]),"isTyping" + "," + messageSplit[2] );
                     
                }
               
                if(messageSplit[0].equals("send-to-person" ) && messageSplit[4].equals("isDone")){
